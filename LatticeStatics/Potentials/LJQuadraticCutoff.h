...
public:
   ...
   LJQuadraticCutoff() {};
   LJQuadraticCutoff(double const& Eps0,double const& Eps1,double const& Sigma0,double const& Sigma1,
            double const& Cutoff);
   ~LJQuadraticCutoff() {};
   ...
   virtual char const* const Type() const {return "LJQuadraticCutoff";}
