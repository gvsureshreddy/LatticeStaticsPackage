#ifndef RSE__RadiiMorseOriginal
#define RSE__RadiiMorseOriginal

#include "PairPotentials.h"

using namespace std;

class RadiiMorseOriginal: public PairPotentials
{
protected:
...
public:
   ...
   virtual char const* const Type() const {return "RadiiMorseOriginal";}
