#ifndef __UniDefTemp3D1PMono
#define __UniDefTemp3D1PMono

#include "LatticeMode.h"
#include "UniDefTempLat.h"
#include <math.h>

class UniDefTemp3D1PMono : public LatticeMode
{
private:
   UniDefTempLat *Lattice_;

public:
   UniDefTemp3D1PMono(UniDefTempLat *M);
   UniDefTemp3D1PMono(Lattice *M);
   ...
   virtual char *ModeName() {return "UniDefTemp3D1PMono";}
