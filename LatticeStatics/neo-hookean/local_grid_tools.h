...
#ifndef LOCAL_GRID_TOOLS_H
#define LOCAL_GRID_TOOLS_H
...
namespace LocalLocalGridTools
{
   ...
   * LocalLocalGridTools::ExcPointNotFound. You can catch this exception and decide what
   * to do in that case.
   *
   ...
   * for example in
   * @code
   *   LocalLocalGridTools::get_active_child_cells<DoFHandler<dim> > (cell)
   * @endcode
   */
   ...
   * following call:
   * @code
   * LocalLocalGridTools::compute_active_cell_halo_layer(tria, pred_mat_id<dim>);
   * @endcode
   *
   ...
   * on material id
   * @code
   * LocalLocalGridTools::compute_active_cell_halo_layer(tria,
   *                                           IteratorFilters::MaterialIdEqualTo(1, true));
   * @endcode
   * or based on a set of active FE indices for an hp::DoFHandler
   * @code
   * LocalLocalGridTools::compute_active_cell_halo_layer(hp_dof_handler,
   ...
   * LocalLocalGridTools::get_patch_around_cell().
   ...
   * common parents (see LocalGridTools::get_cells_at_coarsest_common_level()),
   ...
   * LocalGridTools::build_triangulation_from_patch.
   *
...
/*----------------------------   local_grid_tools.h     ---------------------------*/
/* end of #ifndef LOCAL_GRID_TOOLS_H */
#endif
/*----------------------------   local_grid_tools.h     ---------------------------*/
