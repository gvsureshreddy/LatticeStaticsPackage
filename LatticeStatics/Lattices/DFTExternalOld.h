#ifndef RSE__DFTExternalOld
#define RSE__DFTExternalOld
...
class DFTExternalOld : public Lattice
{
private:
   int DOFS_;
...
public:
   // Functions provided by DFTExternalOld
   DFTExternalOld(PerlInput const& Input, int const& Echo = 1, int const& Width = 20);
   ~DFTExternalOld();
