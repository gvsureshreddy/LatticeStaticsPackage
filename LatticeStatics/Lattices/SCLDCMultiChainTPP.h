#ifndef RSE__SCLDCMultiChainTPP
#define RSE__SCLDCMultiChainTPP
...
class SCLDCMultiChainTPP : public Lattice
{
private:
...
public:
   ...
   // Functions provided by SCLDCMultiChainTPP
   SCLDCMultiChainTPP(PerlInput const& Input, int const& Echo = 1, int const& Width = 20,
                      int const& Debug = 0);
   ~SCLDCMultiChainTPP();
