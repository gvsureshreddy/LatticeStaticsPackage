#ifndef RSE__PseudoHarmonicMultiChainTTPP
#define RSE__PseudoHarmonicMultiChainTTPP
...
class PseudoHarmonicMultiChainTTPP : public Lattice
{
private:
...
public:
   ...
   virtual char const* const Type() const {return "PseudoHarmonicMultiChainTTPP";}
   virtual void DebugMode();
   virtual void Print(ostream& out,PrintDetail const& flag);
   
   // Functions provided by PseudoHarmonicMultiChainTTPP
   PseudoHarmonicMultiChainTTPP(PerlInput const& Input,int const& Echo=1,int const& Width=20,
                  int const& Debug=0);
   ~PseudoHarmonicMultiChainTTPP();
   ...
   friend ostream& operator<<(ostream& out,PseudoHarmonicMultiChainTTPP& A);
