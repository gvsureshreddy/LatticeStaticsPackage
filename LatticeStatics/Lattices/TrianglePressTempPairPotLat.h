#ifndef __TrianglePressTempPairPotLat
#define __TrianglePressTempPairPotLat

#include "UniDefTempLat.h"

class TrianglePressTempPairPotLat : public UniDefTempLat
{
private:
...
public:
   ...
   TrianglePressTempPairPotLat(char *datafile,const char *prefix);
   ...
   friend ostream &operator<<(ostream &out,TrianglePressTempPairPotLat &A);
private:
