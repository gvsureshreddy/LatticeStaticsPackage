...
double MultiChainTTPP::OMEGA(double const* const Dx, int const& p, int const& q, int const& i) const
{
   return LagrangeCB_ ?
...
double MultiChainTTPP::THETA(double const* const DX, int const& p, int const& q, int const& i) const
{
   return LagrangeCB_ ?
          4.0 * RefLattice_[0][0] * DELTA(i, p, q) * DX[0] :
          0.0;
