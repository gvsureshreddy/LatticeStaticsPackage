...
const int PseudoHarmonicMultiChainTTPP::DIM1 = 1;

PseudoHarmonicMultiChainTTPP::~PseudoHarmonicMultiChainTTPP()
{
   delete [] BodyForce_;
   delete [] SpeciesMass_;
   delete [] AtomicMass_;
   ...
   : Lattice(Input,Echo)
{
   ...
   ChainSum_(&DOF_,LagrangeCB_,1,&RefLattice_,INTERNAL_ATOMS,AtomPositions_,Potential_,
...
int PseudoHarmonicMultiChainTTPP::FindLatticeSpacing(int const& iter)
{
   Lambda_=0.0;
   NTemp_=1.0;
   DOF_[0] = 1.0;
...
void PseudoHarmonicMultiChainTTPP::SetParameters(double const* const Vals,int const& ResetRef)
{
...
double PseudoHarmonicMultiChainTTPP::PI(double const* const Dx,double const* const DX) const
{
   return 2.0*Dx[0]*DX[0];
}

double PseudoHarmonicMultiChainTTPP::PSI(double const* const DX) const
{
   return 2.0*DX[0]*DX[0];
}

double PseudoHarmonicMultiChainTTPP::OMEGA(double const* const Dx,int const& p,int const& q,
                                           int const& i)
   const
{
   return LagrangeCB_ ?
...
double PseudoHarmonicMultiChainTTPP::SIGMA(int const& p,int const& q,int const& i,int const& j)
   const
{
   return LagrangeCB_ ?
...
double PseudoHarmonicMultiChainTTPP::GAMMA(double const* const Dx,double const* const DX,
...
double PseudoHarmonicMultiChainTTPP::THETA(double const* const DX,int const& p,int const& q,
                                           int const& i) const
{
   return LagrangeCB_ ?
      4.0*RefLattice_[0][0]*DELTA(i,p,q)*DX[0] :
...
double PseudoHarmonicMultiChainTTPP::XI(int const& p,int const& q,int const& i,int const& j)
   const
{
   return LagrangeCB_ ?
...
double PseudoHarmonicMultiChainTTPP::LAMDA(int const& p,int const& q,int const& i,int const& j)
   const
{
   return LagrangeCB_ ?
...
double PseudoHarmonicMultiChainTTPP::E0() const
{
   double E0,Tsq;
   E0 = energy();
   Tsq=0;
...
double PseudoHarmonicMultiChainTTPP::energy(PairPotentials::TDeriv const& dt) const
{
   double Phi = 0.0;
   double Vr;
   ...
   {
      cerr << "Error in PseudoHarmonicMultiChainTTPP::energy" << "\n";
      exit(-1);
   }
...
Vector const& PseudoHarmonicMultiChainTTPP::E1() const
{
...
Vector const& PseudoHarmonicMultiChainTTPP::stress(PairPotentials::TDeriv const& dt,
                                                   LDeriv const& dl) const
{
   ...
   if (dl==L0)
   {
      ...
      for (ChainSum_.Reset();!ChainSum_.Done();++ChainSum_)
      {
         ...
         {
            cerr << "Error in PseudoHarmonicMultiChainTTPP::stress" << "\n";
            exit(-1);
         }
...
Matrix const& PseudoHarmonicMultiChainTTPP::E2() const
{
   Phi2_static.Resize(DOFS,DOFS,0.0);
   static int i,j;
   Phi2_static=stiffness();
...
Matrix const& PseudoHarmonicMultiChainTTPP::stiffness(PairPotentials::TDeriv const& dt,
                                                      LDeriv const& dl) const
{
   double phi,phi1;
   int i,j;
   ...
   if (dl==L0)
   {
      for (ChainSum_.Reset();!ChainSum_.Done();++ChainSum_)
      {
         ...
         {
            cerr << "Error in PseudoHarmonicMultiChainTTPP::stiffness" << "\n";
            exit(-1);
         }
         ...
         for (i=0;i<INTERNAL_ATOMS;i++)
         {
            Phi2_static[0][i+1] = Phi2_static[i+1][0] +=
...
Matrix const& PseudoHarmonicMultiChainTTPP::E3() const
{
...
Matrix const& PseudoHarmonicMultiChainTTPP::E4() const
{
...
Matrix const& PseudoHarmonicMultiChainTTPP::CondensedModuli() const
{
   Matrix stiff = E2();
   int intrn = DOFS-1;
...
int PseudoHarmonicMultiChainTTPP::comp(void const* const a,void const* const b)
{
   double t;
...
int PseudoHarmonicMultiChainTTPP::abscomp(void const* const a,void const* const b)
{
   double t;
...
void PseudoHarmonicMultiChainTTPP::interpolate(Matrix* const EigVals,int const& zero,
...
CMatrix const& PseudoHarmonicMultiChainTTPP::ReferenceDynamicalStiffness(Vector const& K) const
{
...
void PseudoHarmonicMultiChainTTPP::ReferenceDispersionCurves(Vector const& K,int const& NoPTS,
...
int PseudoHarmonicMultiChainTTPP::ReferenceBlochWave(Vector& K) const
{
...
void PseudoHarmonicMultiChainTTPP::LongWavelengthModuli(double const& dk,int const& gridsize,
                                                        char const* const prefix,ostream& out)
   const
{
}

void PseudoHarmonicMultiChainTTPP::NeighborDistances(int const& cutoff,ostream& out) const
{
   Matrix NeighborDist =
                                         ...
                                         PrintPathSolutionType const& SolType)
{
   ...
   {
      case PrintLong:
         out << "PseudoHarmonicMultiChainTTPP:" << "\n" << "\n";
         ...
         if (Echo_)
         {
            cout << "PseudoHarmonicMultiChainTTPP:" << "\n" << "\n";
...
ostream& operator<<(ostream& out,PseudoHarmonicMultiChainTTPP& A)
{
...
void PseudoHarmonicMultiChainTTPP::RefineEqbm(double const& Tol,int const& MaxItr,
                                              ostream* const out)
{
   Vector dx(DOFS,0.0);
   Vector Stress=E1();
