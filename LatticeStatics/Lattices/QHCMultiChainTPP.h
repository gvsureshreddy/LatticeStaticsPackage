#ifndef RSE__QHCMultiChainTPP
#define RSE__QHCMultiChainTPP
...
class QHCMultiChainTPP : public Lattice
{
private:
   ...
   Vector const& Fstress(PairPotentials::TDeriv const& dt = PairPotentials::T0,
                         LDeriv const& dl = L0) const;
   Matrix const& Fstiffness(PairPotentials::TDeriv const& dt = PairPotentials::T0,
                            LDeriv const& dl = L0) const;
   ...
   CMatrix const& ReferenceDynamicalStiffness(Vector const& K,
                                              PairPotentials::TDeriv const& dt = PairPotentials::T0,
                                              int const& DOFderiv = 0, int const& x = 0,
                                              int const& y = 0) const;
...
public:
   ...
   // Functions provided by QHCMultiChainTPP
   QHCMultiChainTPP(PerlInput const& Input, int const& Echo = 1, int const& Width = 20,
                    int const& Debug = 0);
   ~QHCMultiChainTPP();
   ...
   friend ostream& operator<<(ostream& out, QHCMultiChainTPP& A);
